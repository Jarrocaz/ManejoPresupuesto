...
namespace ManejoPresupuesto.Servicios
{
    ...
    public interface IRepositorioTiposCuentas
    {
        ...
        Task<bool> ExisteCuenta(string nombre, int usuarioId);
    ...
    public class RepositorioTiposCuentas : IRepositorioTiposCuentas
    {
        ...
        private string validarExisteCuenta = $@"SELECT 1 FROM TiposCuentas WHERE Nombre = @Nombre AND UsuarioId = @UsuarioId;";
        ...
        public async Task<bool> ExisteCuenta(string nombre, int usuarioId)
        {
            using var connection = new SqlConnection(conecctionString);
            var existe = await connection.QueryFirstOrDefaultAsync<int>(validarExisteCuenta, new {nombre, usuarioId});
            return existe == 1;
        }
